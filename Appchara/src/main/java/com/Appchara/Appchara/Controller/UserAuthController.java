...
import com.Appchara.Appchara.DTO.LoginRequest;
import com.Appchara.Appchara.DTO.RegistrationRequest;
import com.Appchara.Appchara.Model.Role;
import com.Appchara.Appchara.Model.UserAuth;
import com.Appchara.Appchara.Repository.RoleRepository;
import com.Appchara.Appchara.Repository.UserAuthRepository;



@RestController
@RequestMapping("/api/v1/auth/Userauth")
public class UserAuthController {
    ...
    public ResponseEntity<?> register(@RequestBody RegistrationRequest registrationRequest){
        ...
        if(userAuthRepository.existsByEmail(registrationRequest.getEmail())){
            return new ResponseEntity<>("An account is already registered in this", HttpStatus.BAD_REQUEST);
        }
